      ...
      <div class="grid">
        ...
        <div class="grid__col-xs-12 grid__col-lg-6">
          <div class="mui--text-body2 admin-options">
            ...
            <router-link :to="{ name: 'AddVideo', params: { channel: channel.name }}" v-if="channel.current_action_permissions.includes('new-video')" class="admin-options__actions"><i class="material-icons mui--text-subhead mui--align-top">library_add</i> New video</router-link>
          </div>
        </div>
      </div>
    </div>
